...
| P2 | User preferences don't travel | "Edward prefers conventional commits" must be re-taught per project |
...
```json
{
  ...
  "workingDirectory": "/Users/edward/code/backend-api",
  "user": "edward",
